...
class Weapon: Items {
    ...
    func getItem(str: Point? = nil ?? 0, agi: Point? = nil ?? 0, eng: Point? = nil ?? 0, sta: Point? = nil ?? 0) -> (tier: Int?, name: String?) {
        ...
        case .dk:
            ...
            if (item.str! >= 7960) && (item.agi! >= 3184) {
        ...
        case .dw:
            ...
            if (item.eng! >= 7960) && (item.eng! >= 3184) {
...
class Armor: Items {
    ...
    func getItem(str: Point? = nil ?? 0, agi: Point? = nil ?? 0, eng: Point? = nil ?? 0, sta: Point? = nil ?? 0) -> (tier: Int?, name: String?) {
        ...
        case .mg:
            ...
            if ((item.str! >= 220 || item.eng! >= 220) && (item.agi! >= 217 && item.agi! < 704) && (item.sta! >= 217 && item.sta! < 704)) || (((item.str! >= 220 && item.str! < 352) || (item.eng! >= 220 && item.eng! < 352)) && item.agi! >= 217 && (item.sta! >= 217 && item.sta! < 704)) || (((item.str! >= 220 && item.str! < 352) || (item.eng! >= 220 && item.eng! < 352)) && (item.agi! >= 217 && item.agi! < 704) && item.sta! >= 217) || ((item.str! >= 220 || item.eng! >= 220) && item.agi! >= 217 && (item.sta! >= 217 && item.sta! < 704)) ||
                ((item.str! >= 220 || item.eng! >= 220) && (item.agi! >= 217 && item.agi! < 704) && item.sta! >= 217) {
                item.name = "Atlans Set"
                item.tier = 5
                return (item.tier,item.name)
            }
            if ((item.str! >= 352 || item.eng! >= 352) && (item.agi! >= 704 && item.agi! < 1062) && (item.sta! >= 704 && item.sta! < 1062)) || (((item.str! >= 352 && item.str! < 531) || (item.eng! >= 352 && item.eng! < 531)) && item.agi! >= 704 && (item.sta! >= 704 && item.sta! < 1062)) || (((item.str! >= 352 && item.str! < 531) || (item.eng! >= 352 && item.eng! < 531)) && (item.agi! >= 704 && item.agi! < 1062) && item.sta! >= 704) || ((item.str! >= 352 || item.eng! >= 352) && item.agi! >= 704 && (item.sta! >= 704 && item.sta! < 1062)) || ((item.str! >= 352 || item.eng! >= 352) && (item.agi! >= 704 && item.agi! < 1062) && item.sta! >= 704) {
                item.name = "Valiant Set"
                item.tier = 6
                return (item.tier,item.name)
            }
            if ((item.str! >= 531 || item.eng! >= 531) && (item.agi! >= 1062 && item.agi! < 1546) && (item.sta! >= 1062 && item.sta! < 1546)) || (((item.str! >= 531 && item.str! < 772) || (item.eng! >= 531 && item.eng! < 772)) && item.agi! >= 1062 && (item.sta! >= 1062 && item.sta! < 1546)) || (((item.str! >= 531 && item.str! < 772) || (item.eng! >= 531 && item.eng! < 772)) && (item.agi! >= 1062 && item.agi! < 1546) && item.sta! >= 1062) || ((item.str! >= 531 || item.eng! >= 531) && item.agi! >= 1062 && (item.sta! >= 1062 && item.sta! < 1546)) || ((item.str! >= 531 || item.eng! >= 531) && (item.agi! >= 1062 && item.agi! < 1546) && item.sta! >= 1062) {
                item.name = "Thunder Hawk Set"
                item.tier = 7
                return (item.tier,item.name)
            }
            if ((item.str! >= 772 || item.eng! >= 772) && (item.agi! >= 1546 && item.agi! < 1907) && (item.sta! >= 1546 && item.sta! < 1907)) || (((item.str! >= 772 && item.str! < 953) || (item.eng! >= 772 && item.eng! < 953)) && item.agi! >= 1546 && (item.sta! >= 1546 && item.sta! < 1907)) || (((item.str! >= 772 && item.str! < 953) || (item.eng! >= 772 && item.eng! < 953)) && (item.agi! >= 1546 && item.agi! < 1907) && item.sta! >= 1546) || ((item.str! >= 772 || item.eng! >= 772) && item.agi! >= 1546 && (item.sta! >= 1546 && item.sta! < 1907)) || ((item.str! >= 772 || item.eng! >= 772) && (item.agi! >= 1546 && item.agi! < 1907) && item.sta! >= 1546) {
                item.name = "Athril Set"
                item.tier = 8
                return (item.tier,item.name)
            }
            if ((item.str! >= 953 || item.eng! >= 953) && (item.agi! >= 1907 && item.agi! < 2301) && (item.sta! >= 1907 && item.sta! < 2301)) || (((item.str! >= 953 && item.str! < 1150) || (item.eng! >= 953 && item.eng! < 1150)) && item.agi! >= 1907 && (item.sta! >= 1907 && item.sta! < 2301)) || (((item.str! >= 953 && item.str! < 1150) || (item.eng! >= 953 && item.eng! < 1150)) && (item.agi! >= 1907 && item.agi! < 2301) && item.sta! >= 1907) || ((item.str! >= 953 || item.eng! >= 953) && item.agi! >= 1907 && (item.sta! >= 1907 && item.sta! < 2301)) || ((item.str! >= 953 || item.eng! >= 953) && (item.agi! >= 1907 && item.agi! < 2301) && item.sta! >= 1907) {
                item.name = "Magic Knight Set"
                item.tier = 9
                return (item.tier,item.name)
            }
            if ((item.str! >= 1150 || item.eng! >= 1150) && (item.agi! >= 2301 && item.agi! < 2726) && (item.sta! >= 2301 && item.sta! < 2726)) || (((item.str! >= 1150 && item.str! < 1363) || (item.eng! >= 1150 && item.eng! < 1363)) && item.agi! >= 2301 && (item.sta! >= 2301 && item.sta! < 2726)) || (((item.str! >= 1150 && item.str! < 1363) || (item.eng! >= 1150 && item.eng! < 1363)) && (item.agi! >= 2301 && item.agi! < 2726) && item.sta! >= 2301) || ((item.str! >= 1150 || item.eng! >= 1150) && item.agi! >= 2301 && (item.sta! >= 2301 && item.sta! < 2726)) || ((item.str! >= 1150 || item.eng! >= 1150) && (item.agi! >= 2301 && item.agi! < 2726) && item.sta! >= 2301) {
                item.name = "Volcano Set"
                item.tier = 10
                return (item.tier,item.name)
            }
            if ((item.str! >= 1363 || item.eng! >= 1363) && (item.agi! >= 2726 && item.agi! < 3184) && (item.sta! >= 2726 && item.sta! < 3184)) || (((item.str! >= 1363 && item.str! < 1592) || (item.eng! >= 1363 && item.eng! < 1592)) && item.agi! >= 2726 && (item.sta! >= 2726 && item.sta! < 3184)) || (((item.str! >= 1363 && item.str! < 1592) || (item.eng! >= 1363 && item.eng! < 1592)) && (item.agi! >= 2726 && item.agi! < 3184) && item.sta! >= 2726) || ((item.str! >= 1363 || item.eng! >= 1363) && item.agi! >= 2726 && (item.sta! >= 2726 && item.sta! < 3184)) || ((item.str! >= 1363 || item.eng! >= 1363) && (item.agi! >= 2726 && item.agi! < 3184) && item.sta! >= 2726) {
                item.name = "Hell Knight Set"
                item.tier = 11
                return (item.tier,item.name)
            }
            if ((item.str! >= 1592) || (item.eng! >= 1592)) && (item.agi! >= 3184) && (item.sta! >= 3184) {
                item.name = "Berus Set"
                item.tier = 12
                return (item.tier,item.name)
            }
